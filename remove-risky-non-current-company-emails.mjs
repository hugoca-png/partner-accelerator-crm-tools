...
const targets = new Set([
  "bazevedo7@gmail.com",
  "rui_vitorino@msn.com",
  "ruimgf95@gmail.com",
  "isamdr@gmail.com",
  "cachapa98@gmail.com",
  "briites@hotmail.com",
  "edercarlosdacosta@gmail.com",
]);
...
for (const party of parties) {
  ...
  planned.push({
    ...
    remove: remove.map((entry) => ({ id: entry.id, address: entry.address, type: entry.type || "" })),
...
await writeFile("remove-risky-non-current-company-emails-report.json", JSON.stringify(output, null, 2), "utf8");
console.log(JSON.stringify({
  ...
  report: "remove-risky-non-current-company-emails-report.json",
}, null, 2));
